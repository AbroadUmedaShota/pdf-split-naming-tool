...
- 実装 1 件（TC-E2E-011 / TD049 / TV049 / TA009 / R011）、STEP1優先/追加 12 件（TC-E2E-S1-001〜006, TC-E2E-S1-011, TC-E2E-S1-012, TC-E2E-S1-020〜023）、STEP2/STEP3操作系 4 件（TC-E2E-B6, TC-E2E-B8, TC-E2E-C1, TC-E2E-C2）は `apps/desktop/e2e/desktop-shell.e2e.spec.js` に実装し、トレースコメントを保持。
- E2E レーンの元 18 件（TC-E2E-001〜018）の内訳: 実装 1・退避 17。STEP1優先/追加のブラウザE2E 12件、実機E2E系 8件、STEP2/STEP3操作系 4件を現行資料に反映済み。欠落なし。
